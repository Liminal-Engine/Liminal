...
namespace test {
    namespace jsonio {
        namespace OutJson {
            ...
            using JsonIOOutJsonWriteMethodReturnedStatusParams = std::tuple<
                ::fs::Path, //input path,
                bool, // should it parse input path
                ::jsonio::Status
            >;

            class JsonIOOutJsonWriteMethodReturnedStatus : public ::testing::TestWithParam<JsonIOOutJsonWriteMethodReturnedStatusParams> {
                ...
                protected:
                    ...
                    JsonIOOutJsonWriteMethodReturnedStatus(void) :
                    ...
                    ~JsonIOOutJsonWriteMethodReturnedStatus() {
            ...
            TEST_P(JsonIOOutJsonWriteMethodReturnedStatus, ReturnsGivenStatus) {
