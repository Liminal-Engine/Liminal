        ...
        namespace Array {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    ...
                    std::make_tuple(::test::jsonio::Helper::VALID__EDGE_CASES, "78/40014", std::vector<std::string>{"/", "[", "]"}, true),
                    std::make_tuple(::test::jsonio::Helper::VALID__EDGE_CASES, "78/an.other.[ke.y]", std::vector<std::string>{"/", "<", ">"}, true),
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    ...
                    std::make_tuple(::test::jsonio::Helper::VALID__EDGE_CASES, "78.40014", std::vector<std::string>{"/", "[", "]"}, false),
                    std::make_tuple(::test::jsonio::Helper::VALID__EDGE_CASES, "78/40014[0]/yes", std::vector<std::string>{"/", "[", "]"}, false),
