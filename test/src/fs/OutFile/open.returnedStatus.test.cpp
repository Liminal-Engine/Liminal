...
namespace test {
    namespace fs {
        namespace OutFile {
            ...
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/array/wrongFormat.jso"}, ::fs::Status::E_PATH_NO_TARGET),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/colon/missingInValueStringStringStringStringStringStringObject.json"}, ::fs::Status::E_PATH_NO_TARGET),
            ...
            //     FSOutFileOpenMethod,
            //     testing::Values(
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/array"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/array/"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/bool"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/bool/"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/brace"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/brace/"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/bracket"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/bracket/"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/colon"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/invalid/colon/"}, ::fs::Status::E_PATH_IS_DIR),
            //         std::make_tuple(::fs::Path{"../../test/assets/json/valid"}, ::fs::Status::E_PATH_IS_DIR),
