        ...
        namespace InFile {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    ...
                    std::make_tuple(::fs::Path{"././././/////////./../../test/..////test/assets/jsonio/invalid/bracket/missingOpening.json"}, ::fs::Status::OK),
                ...
                testing::Values(
                    ...
                    std::make_tuple(::fs::Path{"../../test/../../do/not/exists////---/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/array/wrongFormat.jso"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/array/wrongFormat.jso"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/colon/missingInValueStringStringStringStringStringStringObject.json"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/colon/missingInValueStringStringStringStringStringStringObject.json"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    ...
                    std::make_tuple(::fs::Path{"/abc/def/IDoNotExists/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/array"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/array"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/array/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/array/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/bool"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/bool"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/bool/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/bool/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/brace"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/brace"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/brace/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/brace/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/bracket"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/bracket"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/bracket/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/bracket/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/colon"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/colon"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/colon/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/invalid/colon/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/valid"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/jsonio/valid"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/fs/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
                    std::make_tuple(::fs::Path{"../../test/assets/fs/"}, ::fs::Status::E_READ_FILE_NOT_OPENED),
