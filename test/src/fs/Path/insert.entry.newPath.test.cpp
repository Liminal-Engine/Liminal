        ...
        namespace Path {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    ...
                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("../../tests/assets/"), ::fs::Path("/tmp_fs/assets")),

                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("etc"), ::fs::Path("/tmp_fs/etc")),
                    ...
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb", Helper::getEntryFromPath("Проекты"), ::fs::Path("/tmp_fs_oojopjop99---/bbb/Проекты")),
                    std::make_tuple(std::nullopt, Helper::getEntryFromPath("root"), ::fs::Path("./root/../root")),
                    std::make_tuple("/tmp_fs/.complex-dir-name", Helper::getEntryFromPath("subdir"), ::fs::Path("/tmp_fs/.complex-dir-name/subdir/../../.complex-dir-name/subdir")),
