        ...
        namespace Path {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    ...
                    std::make_tuple(std::nullopt, Helper::getEntryFromPath("../../tests/assets/"), ::fs::Status::OK),
                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("../../tests/assets/"), ::fs::Status::OK),

                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("etc"), ::fs::Status::OK),
                    ...
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb", Helper::getEntryFromPath("Проекты"), ::fs::Status::OK),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir"), ::fs::Status::OK),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir2"), ::fs::Status::OK),
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir2"), ::fs::Status::OK),
