        ...
        namespace Path {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    ...
                    std::make_tuple("/tmp", 0, Helper::getEntryFromPath("/tmp/")),
                    ...
                    std::make_tuple("/tmp_oojopjop99---/bbb/Проекты", 2, Helper::getEntryFromPath("/tmp_oojopjop99---/bbb/Проекты")),
                    std::make_tuple("/tmp_oojopjop99---/bbb/Проекты", 2, Helper::getEntryFromPath("../zijerizjrpaokporkezporknnrejnt/Проекты")),
                    std::make_tuple("/tmp_oojopjop99---/bbb/Проекты", 2, Helper::getEntryFromPath("./zijerizjrpaokporkezporknnrejnt/Проекты")),
                    std::make_tuple("/tmp_oojopjop99---/bbb/Проекты", 0, Helper::getEntryFromPath("./zijerizjrpaokporkezporknnrejnt/tmp_oojopjop99---")),
                    std::make_tuple("/tmp_oojopjop99---/bbb/Проекты", 1, Helper::getEntryFromPath("./././././/////bbb/")),
                    std::make_tuple("python3.8", 0, Helper::getEntryFromPath("python3.8")),
                    std::make_tuple("python3.8", 10, ::fs::Entry()),
                    std::make_tuple("/tmp/complex-dir-name", 1, Helper::getEntryFromPath("/tmp/complex-dir-name")),
