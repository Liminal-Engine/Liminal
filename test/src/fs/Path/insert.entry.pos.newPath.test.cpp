    ...
    namespace fs {
        namespace Path {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("."), 1, ::fs::Path("/tmp_fs/././././.")),
                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("etc"), 1, ::fs::Path("/tmp_fs/etc")),
                    ...
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb", Helper::getEntryFromPath("Проекты"), 2, ::fs::Path("/tmp_fs_oojopjop99---/bbb/Проекты/./")),
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb", Helper::getEntryFromPath("Проекты"), 1, ::fs::Path("/tmp_fs_oojopjop99---//Проекты/bbb/./../../../tmp_fs_oojopjop99---/Проекты/bbb/./././")),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir"), 2, ::fs::Path("/tmp_fs/complex-dir-name/subdir////..////../complex-dir-name/subdir///.///.//////../subdir///////.////")),
