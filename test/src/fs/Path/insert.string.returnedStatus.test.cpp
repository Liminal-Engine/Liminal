    ...
    namespace fs {
        namespace Path {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    std::make_tuple("/tmp", ".", ::fs::Status::OK),
                    std::make_tuple("/tmp", "etc", ::fs::Status::OK),
                    std::make_tuple("/aaa/bbb", "ccc", ::fs::Status::OK),
                    std::make_tuple("/aaa/bbb", "ccc", ::fs::Status::OK),
                    std::make_tuple("/tmp_oojopjop99---/bbb", "Проекты", ::fs::Status::OK),
                    std::make_tuple("/tmp_oojopjop99---/bbb", "Проекты", ::fs::Status::OK),
                    ...
                    std::make_tuple("/tmp/complex-dir-name", "subdir", ::fs::Status::OK),
                    ...
                    std::make_tuple("/tmp/complex-dir-name", "subdir2", ::fs::Status::OK),
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                FSPathInsertStringReturnedStatus,
                testing::Values(
                    std::make_tuple("/tmp", "/etc", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    std::make_tuple("/tmp", "et/c", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    ...
                    std::make_tuple("/aaa/bbb", "cc></c", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    std::make_tuple("/tmp_oojopjop99---/bbb", "Пр/оекты", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    std::make_tuple("/tmp_oojopjop99---/bbb", "/Проекты", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    ...
                    std::make_tuple("/tmp/complex-dir-name", "subdi//r", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    ...
                    std::make_tuple("/tmp/complex-dir-name", "/subdir2", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    std::make_tuple("/tmp/complex-dir-name", "s/ubdir2", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    std::make_tuple("/tmp/complex-dir-name", "//subdir2", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
                    std::make_tuple("/tmp/complex-dir-name", "//su/bdir2", ::fs::Status::E_PATH_INVALID_ENTRY_NAME),
