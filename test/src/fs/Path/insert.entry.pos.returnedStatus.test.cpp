        ...
        namespace Path {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    ...
                    std::make_tuple(std::nullopt, Helper::getEntryFromPath("../../tests/assets/"), 0, ::fs::Status::OK),
                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("../../tests/assets/"), 1, ::fs::Status::OK),
                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("etc"), 0, ::fs::Status::OK),
                    ...
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb", Helper::getEntryFromPath("Проекты"), 2, ::fs::Status::OK),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir"), 2, ::fs::Status::OK),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir2"), 2, ::fs::Status::OK),
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir2"), 1, ::fs::Status::OK),
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                FSPathInsertEntryAtPos,
                testing::Values(
                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("etc"), 10, ::fs::Status::E_PATH_INVALID_INDEX),
                    ...
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb", Helper::getEntryFromPath("Проекты"), 4, ::fs::Status::E_PATH_INVALID_INDEX),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir"), 4, ::fs::Status::E_PATH_INVALID_INDEX),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir2"), 20, ::fs::Status::E_PATH_INVALID_INDEX),
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("subdir2"), 20, ::fs::Status::E_PATH_INVALID_INDEX),
