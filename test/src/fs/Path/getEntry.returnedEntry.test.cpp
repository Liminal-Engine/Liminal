        ...
        namespace Path {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    ...
                    std::make_tuple("/tmp_fs", Helper::getEntryFromPath("/tmp_fs")),
                    ...
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb/Проекты", Helper::getEntryFromPath("/tmp_fs_oojopjop99---/bbb/Проекты")),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", Helper::getEntryFromPath("/tmp_fs/complex-dir-name")),
