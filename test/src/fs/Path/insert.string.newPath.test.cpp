    ...
    namespace fs {
        namespace Path {
            ...
            INSTANTIATE_TEST_SUITE_P(
                ...
                testing::Values(
                    std::make_tuple("/tmp_fs", ".", ::fs::Path("/tmp_fs/././././.")),
                    std::make_tuple("/tmp_fs", "etc", ::fs::Path("/tmp_fs/etc")),
                    std::make_tuple("/aaa/bbb", "ccc", ::fs::Path("/aaa/bbb/ccc/")),
                    std::make_tuple("/aaa/bbb", "ccc", ::fs::Path("/aaa/bbb/ccc/./.././ccc/./.")),
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb", "Проекты", ::fs::Path("/tmp_fs_oojopjop99---/bbb/Проекты/./")),
                    std::make_tuple("/tmp_fs_oojopjop99---/bbb", "Проекты", ::fs::Path("/tmp_fs_oojopjop99---/bbb/Проекты/./../../../tmp_fs_oojopjop99---/bbb/Проекты/./././")),
                    ...
                    std::make_tuple("/tmp_fs/complex-dir-name", "subdir", ::fs::Path("/tmp_fs/complex-dir-name/subdir////..////../complex-dir-name/subdir///.///.//////../subdir///////.////")),
