...
namespace rhi {
    ...
    def::Handle Registry::getShaderHandle(const std::string &name) const { return this->__impl->getShaderHandle(name); }
    def::Handle Registry::getTextureHandle(const std::string &name) const { return this->__impl->getTextureHandle(name); }
    def::Handle Registry::getMeshHandle(const std::string &name) const { return this->__impl->getMeshHandle(name); }
