...
#ifndef _LIMINAL_LIB_VULKAN_WRAPPER__QUEUE_QUEUFAMILIES_HPP_
#define _LIMINAL_LIB_VULKAN_WRAPPER__QUEUE_QUEUFAMILIES_HPP_
...
namespace vulkan_wrapper {
    namespace _private {
        namespace _queue {
            ...
            using _QueueFamilyIndex_t = uint32_t; ///< _QueueFamilyIndex_t type
...
#endif // _LIMINAL_LIB_VULKAN_WRAPPER__QUEUE_QUEUFAMILIES_HPP_