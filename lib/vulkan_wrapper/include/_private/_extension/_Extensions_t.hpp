#ifndef _LIMINAL_LIB_VULKAN_WRAPPER__EXTENSION__EXTENSION_T_HPP_
#define _LIMINAL_LIB_VULKAN_WRAPPER__EXTENSION__EXTENSION_T_HPP_
...
#endif // _LIMINAL_LIB_VULKAN_WRAPPER__EXTENSION__EXTENSION_T_HPP_
