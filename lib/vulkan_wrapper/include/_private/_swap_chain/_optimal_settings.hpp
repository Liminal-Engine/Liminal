...
#ifndef _LIB_VULKAN_WRAPPER__SWAP_CHAIN__OPTIMAL_SETTINGS_HPP_
#define _LIB_VULKAN_WRAPPER__SWAP_CHAIN__OPTIMAL_SETTINGS_HPP_
...
namespace vulkan_wrapper {
    namespace _private {
        namespace _swap_chain {
             ...
             * 
             * @param window (const windowing::WindowWrapper &) -  The related window
             ...
             */
            VkExtent2D _getBestExtent(const windowing::WindowWrapper &window, const VkSurfaceCapabilitiesKHR &surface_capabilities);
...
#endif // _LIB_VULKAN_WRAPPER__SWAP_CHAIN__OPTIMAL_SETTINGS_HPP_