...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        std::make_pair(liminal_json_io_test::paths::INVALID__ARRAY__WRONG_FORMAT, json_io::Status::PARSING_ERR),
        
        std::make_pair(liminal_json_io_test::paths::INVALID__BOOL__INCOMPLETE, json_io::Status::PARSING_ERR),

        std::make_pair(liminal_json_io_test::paths::INVALID__BRACE__MISSING_CLOSING, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__BRACE__MISSING_OPENING, json_io::Status::PARSING_ERR),

        std::make_pair(liminal_json_io_test::paths::INVALID__BRACKET__MISING_CLOSING, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__BRACKET__MISING_OPENING, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__BRACKET__MISING_OPENING_AT_ROOT, json_io::Status::PARSING_ERR),

        std::make_pair(liminal_json_io_test::paths::INVALID_COLON__MISSING, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID_COLON__TOO_MANY, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID_COLON__TOO_MANY_IN_SIMPLE_KEY_VALUE_PAIR, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID_COLON__WRONG_CHAR, json_io::Status::PARSING_ERR),

        std::make_pair(liminal_json_io_test::paths::INVALID__COMMA__MISPLACED, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__COMMA__MISSING, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__COMMA__MISSING_IN_ARRAY, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__COMMA__MISSING_IN_NESTED_ARRAY, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__COMMA__MISSING_IN_NUM_ARRAY, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__COMMA__MULTIPLE_MISSING_IN_ARRAY, json_io::Status::PARSING_ERR),
        std::make_pair(liminal_json_io_test::paths::INVALID__COMMA__TOO_MUCH, json_io::Status::PARSING_ERR)
...
INSTANTIATE_TEST_SUITE_P(
    ...
    LiminalJsonIOInJsonParseMethod,
    testing::Values(
        std::make_pair(liminal_json_io_test::paths::VALID__BASIC, json_io::Status::OK),
        std::make_pair(liminal_json_io_test::paths::VALID__EDGE_CASES, json_io::Status::OK),
        std::make_pair(liminal_json_io_test::paths::VALID__NESTED, json_io::Status::OK),
        std::make_pair(liminal_json_io_test::paths::VALID__LARGE, json_io::Status::OK)
    )
);
...
//     LiminalJsonIOInJsonParseMethod,
//     testing::Values(
//         std::make_pair(liminal_json_io_test::paths::INEXISTANT_PATH, json_io::Status::NOK),
//         std::make_pair(liminal_json_io_test::paths::VALID__BASIC + liminal_json_io_test::paths::INEXISTANT_PATH, json_io::Status::NOK),
//         std::make_pair(liminal_json_io_test::paths::MISSING_LETTER_IN_FILE_EXT, json_io::Status::NOK)
//     )
// );
